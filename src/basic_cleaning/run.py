...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "Name of input artifact to read",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "Name of output artifact to create",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "Description of output artifact contents",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "Minimum price to keep in dataset",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "Maximum price to keep in dataset",
        required = True
    )
